...
INSERT IGNORE INTO users (user_name, email, login, password, user_type, address, last_update_date) VALUES ("nome usuario 1", "email1@gmail.com", "LoginUsuario1", "$2a$10$UqmSCvzIURnuZj3a5m/VXu1fma2hWZJVsYYJZVxmsypJZGqVWKcKC", 1, 1, CURRENT_DATE);